...
const migrate = async(chainID: number, RPC_URL: string, EOAAddress: string, SAFEAddress: string, tokenAddresses: string[]) => {
  ...
  if (tokenAddresses.length == 0){
    tokenBalances.forEach(async token => {
      const erc20Contract = new ethers.Contract(token.tokenAddress,
        erc20ABI,
...
migrate(5, process.env.RPC_URL || " ", "0x6Ed66a9F6a2885f2E807ce36358819F54Ef43c90", "0xFE9F5c37D394aDa800d6B76222C871aCbdA3d660", []);
